...
<div class="card card-margin">
    ...
    <div class="card-body">
        <div class="container">
            ...
            <div class="row"><span class="attribute">Название работы: </span><pre class="text"> <?= $work['name']?></pre></div>
            <div class="row"><span class="attribute">Фамилии студентов: </span><pre class="text"> <?= $work['students_names']?></pre></div>
            <div class="row"><span class="attribute">Руководитель: </span><pre class="text"> <?= $work['teacher_name'] ?></pre></div>
            <div class="row"><span class="attribute">Номер группы: </span><pre class="text"> <?= $work['number']?></pre></div>
            <div class="row"><span class="attribute">Статус публкации: </span><pre class="text"> <?= $work['pub_status']?></pre></div>
            <div class="row"><span class="attribute">Отрасль науки: </span><pre class="text"> <?= $work['science_branch']?></pre></div>
            <div class="row"><span class="attribute">Специальность: </span><pre class="text"> <?= $work['specialty']?></pre></div>
