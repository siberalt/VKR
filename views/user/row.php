        ...
        <div class="col ">
            <div class="row justify-content-end align-items-center button-more">
                ...
                <button class="btn btn-danger option-button delete"
                        type="button"
                        onClick='location.href=<?= '"'.Url::to(['user/delete','id'=>$user['id']],true).'"';?>'>
            ...
            <div class="row"> <span class="attribute">Ученая степень: </span><pre class="text"> <?= $degree ?> </pre></div>
            <div class="row"> <span class="attribute">Ученое звание: </span><pre class="text"> <?= $rank ?> </pre></div>
        </div>
    </div>
</div>
